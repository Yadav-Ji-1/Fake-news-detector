...
# ---------------- Footer ----------------
st.markdown('<p class="footer">Made with ❤️ - Himanshu</p>', unsafe_allow_html=True)page = st.radio(
    label="Menu",
    options=["Check News", "History", "About"],
    horizontal=True if hasattr(st, 'radio') else False,  # Safe for older Streamlit
    key="unique_menu_radio_123",
...
# ---------------- Footer ----------------
st.markdown('<p class="footer">Made with ❤️ - Himanshu</p>', unsafe_allow_html=True)    horizontal=True,
    key="unique_menu_radio_123",
    label_visibility="hidden"
)
st.markdown('</div>', unsafe_allow_html=True)
